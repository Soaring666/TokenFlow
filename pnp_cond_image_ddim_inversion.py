...
def run(opt):
    ...
    save_path = os.path.join(opt.save_dir, os.path.splitext(os.path.basename(opt.data_path))[0])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str,
                        default='data/wt.jpg')
    parser.add_argument('--save_dir', type=str, default='pnp_cond_image_latents')
    parser.add_argument('--sd_version', type=str, default='2.1', choices=['1.5', '2.0', '2.1'],
                        help="stable diffusion version")
    parser.add_argument('--seed', type=int, default=1)
    parser.add_argument('--steps', type=int, default=999)
    parser.add_argument('--save-steps', type=int, default=50)
    parser.add_argument('--inversion_prompt', type=str, default='man')
