...
class BlipDiffusion(BaseModel):
    ...
    def __init__(
        ...
        qformer_train=False,
        sd_pretrained_model_name_or_path="/home/flyvideo/PCH/diffusion/stable-diffusion/stable-diffusion-v1-5",
        ...
        self.sd_pretrained_model_name_or_path = sd_pretrained_model_name_or_path
    ...
    def ddim_scheduler(self):
        if not hasattr(self, "_ddim_scheduler"):
            self._ddim_scheduler = DDIMScheduler.from_config(
                self.sd_pretrained_model_name_or_path, subfolder="scheduler"
            )
    ...
    def _forward_prompt_embeddings(self, input_image, src_subject, prompt):
        ...
        query_embeds = self.forward_ctx_embeddings(input_image, src_subject)    #(b, 16, 768)改成16是为了减少对文本prompt的影响
    ...
    def edit(
        ...
        )       #由src_image和src_subject+prompt得到的DDIM inversion inv_latents
    ...
    def forward_ctx_embeddings(self, input_image, text_input, ratio=None):
        ...
        if self._use_embeddings_cache:
            ...
            for inp_image, inp_text in zip(input_image, text_input):
                ctx_embeddings = compute_ctx_embeddings(inp_image, inp_text)        #(1, 16, 768)
